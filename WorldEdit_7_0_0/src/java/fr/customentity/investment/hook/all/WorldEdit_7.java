...
/**
 * Created by CustomEntity on 6/29/2019 for [SpigotMc] Investment.
 */
public class WorldEdit_7 implements WorldEditSelection {

    private final WorldEditPlugin plugin;

    public WorldEdit_7(JavaPlugin javaPlugin) {
